...
/**
 * @author LiMingHang
 * @date2019.03.05 12:28.
 */
public class JDBCUtil {
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/dbrlg?useUnicode=true&characterEncoding=utf8";
...
//        return result;
    ...
    public static int queryCount(String sql, Object... objs) {
        ...
        try {
            ...
            rs = pstmt.executeQuery();
            while (rs.next()) {
                result = rs.getInt(1);//通过设定第几列，获取值
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
